...
const styles = StyleSheet.create({
  ...
  backgroundCircle: {
    ...
    borderRadius: 175, backgroundColor: '#FFF4E6',
    top: 170, left: '75%', transform: [{ translateX: -175 }]
  },
  mainContent: {
  ...
  mainText: { fontSize: 20, color: '#333', textAlign: 'center', fontWeight: '800' },
  highlightText: { fontWeight: '300', color: '#333' },
  underlineText: { color: 'teal', fontWeight:'bold' },
  bottomBar: {
    backgroundColor: '#FFF', paddingHorizontal: 30, paddingVertical: 25,
    alignItems: 'center', borderTopLeftRadius: 25, borderTopRightRadius: 25,
    elevation: 5
  },
  startButton: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: 'teal', paddingHorizontal: 25, paddingVertical: 15,
    borderRadius: 25, marginBottom: 20, minWidth: 250
  },
  startButtonText: { color: '#FFF', fontSize: 18, fontWeight: '600', flex: 1, textAlign: 'center' },
  arrowContainer: {
    backgroundColor: '#FFA500', width: 35, height: 35,
    borderRadius: 25, alignItems: 'center', justifyContent: 'center'
  },
  projectTitle: { fontSize: 16, color: '#666', fontWeight: '800', marginBottom: 5 },
  digitalText: { fontSize: 14, color: '#999' },
  ...
  modalTitle: { fontSize: 22, fontWeight: 'bold', color: 'teal', marginBottom: 15 },
  tablesGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center' },
  tableBtn: {
    width: 45, height: 45, backgroundColor: 'teal', margin: 5,
    justifyContent: 'center', alignItems: 'center', borderRadius: 8
  },
  tableText: { color: 'white', fontSize: 18, fontWeight: 'bold' },
  closeBtn: {
    backgroundColor: 'red', paddingVertical: 10,
    paddingHorizontal: 25, borderRadius: 8, marginTop: 15
  },
});
